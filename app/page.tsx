...
const features = [
  {
    ...
    desc: "Book video/audio calls with Nabha Civil Hospital doctors. No travel needed.",
    href: "/consultation",
  ...
  },
  {
    ...
    desc: "Store prescriptions, medical history and lab reports. Access offline, share via QR.",
    href: "/health-records",
    color: "border-green-800 hover:border-green-500",
  },
  {
    icon: <Pill size={28} className="text-yellow-400" />,
    title: "Medicine Availability",
    desc: "Check medicine info with AI and find nearby pharmacies — before you travel.",
    href: "/medicine",
    color: "border-yellow-800 hover:border-yellow-500",
  },
  {
    icon: <Mic size={28} className="text-purple-400" />,
    title: "AI Symptom Checker",
    desc: "Describe symptoms in Hindi or Punjabi by voice. Get instant AI health guidance.",
    href: "/health-check",
  ...
  },
  {
    ...
    title: "Works Offline",
    desc: "Installed like an app on your phone. Health records available even without internet.",
    href: "/health-records",
  ...
  },
  {
    ...
    title: "Emergency SOS",
    desc: "One tap to call ambulance (108), police (100), or Nabha Civil Hospital directly.",
    href: "#",
...
const steps = [
  {
    ...
    desc: "Create your health profile with name, village, blood group and allergies.",
    color: "text-blue-400",
  },
  {
    num: "02",
    title: "Describe Symptoms",
    desc: "Speak or type your symptoms in Hindi/Punjabi. AI gives instant guidance.",
    color: "text-green-400",
  },
  {
    num: "03",
    title: "Book a Doctor",
    desc: "Pick from 11 available doctors at Nabha Civil Hospital and book a video call.",
    color: "text-yellow-400",
  },
  {
    num: "04",
    title: "Consult Remotely",
    desc: "Join your video consultation from home. Doctor updates your records directly.",
    color: "text-purple-400",
  },
  {
    num: "05",
    title: "Collect Medicines",
    desc: "See which pharmacies near you have your prescribed medicines in stock.",
    color: "text-red-400",
  },
];
...
export default function HomePage() {
  ...
  useEffect(() => {
    const t = setInterval(() => setHeroIndex(i => (i + 1) % heroLines.length), 3000);
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 text-center overflow-hidden">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-blue-900/40 border border-blue-700/50 rounded-full px-4 py-1.5 text-blue-300 text-sm font-medium mb-6">
            ...
            Rural TeleHealth Access System — Nabha, Punjab
          </div>
          ...
          <div className="h-20 sm:h-24 flex items-center justify-center mb-4">
            <motion.h1
              ...
              className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight bg-gradient-to-r from-white via-blue-200 to-green-300 bg-clip-text text-transparent"
            >
              {heroLines[heroIndex]}
            </motion.h1>
          </div>
          ...
          <p className="text-gray-400 text-base sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Bridging the healthcare gap for <strong className="text-white">173 villages</strong> around Nabha Civil Hospital
            through AI-powered telemedicine — works even offline.
          </p>
      ...
      <section ref={statsRef} className="py-16 px-4 border-y border-gray-800 bg-gray-950/50">
        <div className="max-w-5xl mx-auto">
          <p className="text-center text-gray-500 text-sm uppercase font-semibold tracking-widest mb-10">
            The Problem We're Solving — Real Data from Nabha
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            {[
              { value: c1, suffix: "", label: "Villages Served", sub: "by Nabha Civil Hospital", icon: <MapPin size={20} className="text-blue-400" /> },
              { value: c2, suffix: "/23", label: "Doctors Available", sub: "out of sanctioned posts", icon: <Users size={20} className="text-red-400" /> },
              { value: c3, suffix: "%", label: "Rural Internet", sub: "households with access", icon: <Wifi size={20} className="text-yellow-400" /> },
              { value: `${(c4/1000).toFixed(0)}K+`, suffix: "", label: "People Affected", sub: "across rural Punjab", icon: <Building2 size={20} className="text-green-400" /> },
            ].map((stat, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-10 text-sm">6 features built for rural India — works on older phones, in Hindi & Punjabi, even offline</p>
      ...
      <section className="py-16 px-4 bg-gray-950/60 border-t border-gray-800">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-12 text-sm">From symptom to treatment — entirely from your village</p>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-blue-900/40 to-green-900/30 border-t border-gray-800">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3">Start Your Health Journey</h2>
          <p className="text-gray-400 mb-6 text-sm">Register as a patient, consult a doctor, and manage your health — all for free.</p>
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href="/health-records">
              <Button className="bg-white text-black hover:bg-gray-100 font-semibold px-6 py-5 rounded-xl flex items-center gap-2">
                <FileText size={16} /> Register as Patient
              </Button>
            </Link>
